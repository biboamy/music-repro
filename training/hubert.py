...
class HubertModel(HubertPreTrainedModel):
    def __init__(self, config: HubertConfig):
        ...
        self.delta = torch.nn.Conv1d(512, 512, 3, 1, 1)
        #self.delta = torch.nn.Parameter(torch.Tensor(1, 200, 512), requires_grad=True)
    ...
    def forward(
        ...
        # b X time X freq
        #extract_features = F.pad(extract_features, (0, 0, 0, 51), "constant", 0) + self.delta
        extract_features = self.delta(extract_features.permute(0, 2, 1)).permute(0, 2, 1)
